...
#define USER_FLASH_WRITE_READ_GIPO_PORT          	CMA_GPIO_PORT_A
#define USER_FLASH_WRITE_READ_GPIO_NUM           	CMA_GPIO_PIN_7     /* GPIOA 7 */
#define USER_FLASH_WRITE_READ_GPIO_FUNC_PIN      	CMA_GPIO_FUNC_GPIO_A7
